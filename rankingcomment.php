...
<html lang="ja">
    ...
    <title>comment</title>
    <link rel="stylesheet" href="CSS/rankingcomment.css">
    <script src="JS/rankingcomment.js"></script>
</head>
<body>
    <header>
        <!--ハンバーガーメニュー-->
        ...
        <div class="box">
            ...
            <!--コメント用フォーム-->
            <h3>コメントする</h3>
            <form action="rankcommentok.php" method="POST">
                ...
                <table>
                    <tr>
                        ...
                        <td class="third">
                            ...
                            <!--削除フォーム-->
                            <form action="rankcommentdel.php" method="post">
                                <!--トークンの送信-->
                                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token;?>">
