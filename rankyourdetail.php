		...
		<?php foreach($stmt as $loop):?>
            <div class="spot">
                 <p class="name">
                    ...
                    <!--　フォローページ　-->
                    <form class="btn_tr" action="rankyourpage.php" method="POST">
             ...
             <div class="iine">
                 <div class="many">&nbsp;いいね！ : <?php echo $loop['likes']?>件</div>
                    <div class="like_many">
                        ...
                        <!--いいね機能　フォーム-->
                        <form action="rankyourlove.php" method="POST" name="like_btn">
             ...
             <div class="urls">
                 <div class="urls">
                    ...
                    <!-- 戻る -->
                    <form action="rankyourpage.php" method="POST">
                        <input type="hidden" name="num" value="<?php echo $num ?>">
                        <input type="hidden" name="name" value="<?php echo $loop['name']; ?>">
                        <button type="submit">戻る</button>
                    </form>
                     <form action="rankyourcomment.php" method="POST">
