...
<body>
    ...
    <div class="box">
        <form action="confirm.php" method="post" enctype="multipart/form-data">
             ...
             <h3>コメント</h3>
             <textarea name="contents" value="" placeholder="例 : 箱根温泉" rows="5" cols="30"></textarea><br>
             <h3>タグ</h3>
             <input type="text" name="tag" value="" placeholder="例 : ＃神奈川県 ＃箱根温泉" size="30" required style="height:25px;"><br>
             <h3><input type="file" name="upload_image" size="30" required style="height:25px;"><br></h3>
