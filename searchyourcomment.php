...
<html lang="ja">
    ...
    <title>comment</title>
    <link rel="stylesheet" href="CSS/searchcomment.css">
    <script src="JS/searchcomment.js" async></script>
...
<body>
    ...
    <div class="box">
        ...
        <!--コメント用フォーム-->
        <h3>コメントする</h3>
        <form action="searchyourcommentok.php" method="POST">
            ...
            <table>
                <tr>
                    ...
                    <td class="third">
                        ...
                        <!--削除フォーム-->
                        <form action="searchyourcommentdel.php" method="post">
                            <!--トークンの送信-->
                            <input type="hidden" name="csrf_token" value="<?php echo $csrf_token;?>">
        ...
        <!--ボタン-->
        <div class="urls">
            <form action="searchyourdetail.php" method="POST">
                <input type="hidden" name="id" value="<?php echo $id ?>">
                <input type="hidden" name="num" value="<?php echo $num ?>">
